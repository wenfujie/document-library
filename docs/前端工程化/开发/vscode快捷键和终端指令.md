...
| Mac 快捷键                    | Win 快捷键             | 作用                                 | 备注 |
| ----------------------------- | ---------------------- | ------------------------------------ | ---- |
| **Cmd + Option + 左右方向键** | Ctrl + Pagedown/Pageup | 在已经打开的**多个文件**之间进行切换 |      |
| Cmd + Shift + O               | Ctrl + shift + O       | 查找方法、变量并跳转（文件级）       | 常用 |
| Cmd + Shift + T               |                        | 查找方法或变量并跳转（项目级别）     |      |

### 光标移动

| Mac 快捷键              | Win 快捷键                                 | 作用                                 | 备注           |
| ----------------------- | ------------------------------------------ | ------------------------------------ | -------------- |
| Cmd + k Cmd + q         |                                            | 回到编辑位置                         | 编辑内容不撤回 |
| cmd + -                 |                                            | 返回（支持跨文件）                   | 常用           |
| cmd + u                 |                                            | 返回（仅当前文件，栈为光标移动级别） | 个人感觉不好用 |
