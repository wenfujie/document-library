...
- [面试题整理](#面试题整理)
  ...
  - [ES6](#es6)
    ...
    - [Promise](#promise)
      - [使用Promise实现每隔1秒输出1,2,3](#使用promise实现每隔1秒输出123)
      - [使用Promise实现红绿灯交替重复亮](#使用promise实现红绿灯交替重复亮)
      - [实现mergePromise函数](#实现mergepromise函数)
      - [根据promiseA+实现一个自己的promise](#根据promisea实现一个自己的promise)
      - [使用Promise封装一个异步加载图片的方法](#使用promise封装一个异步加载图片的方法)
      - [限制异步操作的并发个数并尽可能快的完成任务](#限制异步操作的并发个数并尽可能快的完成任务)
  - [Vue](#vue)
  - [对工具的理解](#对工具的理解)
  - [解决方案](#解决方案)
  - [常考题](#常考题)
